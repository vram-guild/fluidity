...
import grondag.fluidity.api.storage.BulkArticleView;
import grondag.fluidity.impl.AbstractFraction;
import net.minecraft.nbt.CompoundTag;
import net.minecraft.util.PacketByteBuf;

public abstract class AbstractBulkArticle<T extends AbstractFraction, V extends AbstractBulkArticle<T, V>> implements BulkArticleView<V> {
    // Common units
