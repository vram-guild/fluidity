...
public interface ArticleType<T> {
	...
	/**
	 *
	 * @return True if this article is meant to be divisible to
	 * subunits and thus ought to be measured using fractions.
	 * Advisory only.
	 */
	boolean isBulk();
	...
	interface Builder<U> {
		...
		Builder<U> keyFunction(Function<U, String> keyFunction);
